...
export default function MessageAction(props: {
  ...
  return (
    <Show when={!props.hidden}>
      <div class="flex absolute items-center justify-between sm:top-3 sm:right-2 top--2 right-0 text-sm text-slate-7 dark:text-slate group-hover:opacity-100 group-focus:opacity-100 opacity-0 bg-slate bg-op-10 rounded">
        <Switch>
